...
<body class="body-wrapper">
		...
		<div class="row">
			<div class="row">
				<div class="dropdown" style="text-align: right; margin-right: 20px; padding-right: 10px">
					...
					<button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">
						<span id="orderText">추천순 </span><span class="caret"></span>
					</button>
					<ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="menu1">
						<li><a href="${pageContext.request.contextPath}/me_report_list?order=thumbup">추천순</a></li>
						<li><a href="${pageContext.request.contextPath}/me_report_list?order=new">최신순</a></li>
			...
			<div class="blog-masonary-wrapper">
				<div class="container mas-boxes">
					<c:forEach var="listValue" items="${normalList}">
						...
						<!-- GALLERY ITEM START -->
						<div class="mas-boxes-inner" style="border: 4px solid ${color}; border-radius: 5px;  max-height: 500px;">
							<div class="mas-blog-inner">
								<h3 style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
									<a style="overflow: hidden; text-overflow: ellipsis" href="${pageContext.request.contextPath}/report_detail?report_rcdno=${listValue.m2_report_rcdno}">${listValue.m2_report_title}</a>
								</h3>
								<c:if test="${listValue.m2_report_Aispublic eq 'on' }">
	...
	<script type="text/javascript">
		...
		function navMenuColorSetting() {
			...
			//서버용
			if (urlpath.indexOf("/me_report_list") != -1) {
			
				$("#navmenu_me_report_list").css("color", "#39a1f4");
