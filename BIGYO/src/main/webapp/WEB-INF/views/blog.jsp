...
<link href="resources/plugins/bootstrapthumbnail/bootstrap-thumbnail.css"
	rel="stylesheet">
								...
								<li class="col-sm-4 col-xs-12">
									<ul class="list-unstyled">
										<li class="mega-img"><a href=""><img
												src="resources/img/works/works-big-3.png" alt=""></a></li>
									</ul>
								</li>
							</ul></li>
						<li class=" dropdown singleDrop"><a href="#"
				...
				<div class="col-sm-8 col-xs-12">
					<div class="blogInnerWrapper">
						<!-- <div class="thumbnail blogInner">
							<img src="resources/img/blog/blog-1.jpg" alt="Image blog"
							...
							<div class="caption">
								...
								<h3>
									<a href="blog-details.html">Donec id dolor in erat
										imperdiet.</a>
								</h3>
						...
						<div class="thumbnail blogInner">
							<div id="blog-carousel-id" class="carousel slide"
								data-ride="carousel">
								<div class="carousel-inner">
									<div class="item active">
										<img src="resources/img/blog/blog-2.jpg" alt="Image blog">
									</div>
									<div class="item">
										<img src="resources/img/blog/blog-1.jpg" alt="Image blog">
									</div>
								</div>
								<a class="left carousel-control" href="#blog-carousel-id"
									data-slide="prev"><i class="icon-listy icon-left-arrow-3"></i></a>
								<a class="right carousel-control" href="#blog-carousel-id"
									data-slide="next"><i class="icon-listy icon-right-arrow-3"></i></a>
							</div>
							<div class="caption">
								<h4>
									Nov 22, 2016 by <a href="#">Admin</a>
...
<!-- 							<div class="caption">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul class="list-unstyle categoryList">
									...
									<li><a href="#">Morbi pretium ipsum ac massa
											sollicitu.</a></li>
									<li><a href="#">Etiam eget augue et lorem sagittis.</a></li>
									<li><a href="#">Sed mollis tincidunt massa vel
											egestas.</a></li>
		...
		<!-- FOOTER -->
		<footer style="background-image: url(resources/img/background/bg-footer.jpg);">
		<!-- FOOTER INFO -->
