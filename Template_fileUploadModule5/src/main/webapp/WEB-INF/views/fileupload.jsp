...
<body class="body-wrapper">
	...
	<div class="main-wrapper">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<form action="insert_eventhos_process" id="multiform" name="multiform" method="post" class="listing__form" enctype="multipart/form-data">
	...
	<script type="text/javascript">
 	...
 	/* 	$("#btnSubmit").click(
		...
		function sendFileToServerByAjax(formData) {
			var uploadURL = "/template_fileUploadModule5/insert_eventhos_process";
	/* 	 	var uploadURL = "/template_fileUploadModule5/fileUpload/postByAjax"; //Upload URL */
