...
<body class="body-wrapper">
				...
				<form role="form" id="tvtopic_insert_form" method="post" enctype="multipart/form-data" action="tvshowtopic_insert_process">
					<div class="container">
						...
						<div class="center-heading" style="text-align: center">
							<h2>
								일반 쇼피니언 주제 제목 입력하기 <input class="form-control" id="tvtopic_name_input" placeholder="TV토론 주제 제목" name="tvtopic_name_input" type="text" style="width: 80%; margin: 0 auto;">
							</h2>
											...
											<div style="display: none">
												<h4>
													방송이름 <select class="selectpicker" data-width="100%" id="tvtopic_tvshow_name" name="tvtopic_tvshow_name" style="width: 80%;">
														<option value="normal_topic">일반 쇼피니언 주제</option>
	...
	<script type="text/javascript">
		...
		function navMenuColorSetting() {
			...
			//서버용
			if (urlpath.indexOf("/admin_insert_normalTopic") != -1) {
				$("#admin_sidenav_insert_normalTopic").css("color", "#39a1f4");
			}
