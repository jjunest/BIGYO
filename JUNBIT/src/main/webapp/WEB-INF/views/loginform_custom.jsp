...
<body class="body-wrapper">
	...
	<div class="main-wrapper">
		...
		<!-- LOGIN SECTION -->
		<section class="clearfix loginSection"> <c:url value="j_spring_security_check" var="loginUrl" />
		<div class="container">
			<div class="row">
						...
						<div class="panel-body">
							<form action="${loginUrl}" method="post" class="loginForm">
								<div class="form-group">
									<label for="userName">아이디 *</label> <input type="text" class="form-control" id="userName" name="j_username">
									<p class="help-block"></p>
								</div>
								<div class="form-group">
									<label for="userPassword">비밀번호 *</label> <input type="password" class="form-control" id="userPassword" name="j_password">
									<p class="help-block"></p>
								</div>
								<div class="form-group">
									<button type="submit" class="btn btn-primary" style = "width:100%">로그인</button>
									<!-- <a href="#" class="pull-right link">비밀번호를 잊으셨나요?</a> -->
								</div>
							</form>
						</div>
						<div class="panel-footer text-center">
							<p>
								회원이 아니신가요? <a href="signup" class="link">준비트 회원가입</a>
							</p>
						</div>
					</div>
				</div>
