...
<body class="body-wrapper">
	...
	<div class="main-wrapper">
		...
		<section>
		<form class="form-inline" id="frmSearch" action="${pageContext.request.contextPath}/coininfoboard/list">
...
<!-- 나만 버튼이 보이도록 하는 코드 시작 -->
						<c:set var="login_username" value="${pageContext.request.userPrincipal.name}" />
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("a[name='subject']").click(function() {
				...
				location.href = "${pageContext.request.contextPath}/coininfoboard/view?id=" + $(this).attr("content_id");

			});

			$("#write").click(function() {
				location.href = "${pageContext.request.contextPath}/coininfoboard/edit";
			});
