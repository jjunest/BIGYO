...
public class ImageService {
	...
	private void init() {
		...
		imageFilesMap = new HashMap<String, File>();
	 ...
	 */
	public File save(MultipartFile multipartFile, HttpSession session) {
		...
		try {
			...
			imageFile = new File(genId, multipartFile.getContentType(), (int) multipartFile.getSize(),
					savedFileName);
