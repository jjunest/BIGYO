...
<!-- FOOTER -->
<footer style="background-image: url(resources/img/background/bg-footer-2.jpg);"> <!-- FOOTER INFO --> < <!-- <div class="clearfix footerInfo">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="copyRightWrapper">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<div class="copyRightText">
								<ul class="list-styled list-contact">
									<li><h3 style = "color: white">(주) 이노베스트</h3></li>
									<li>대표: 김준혁</li>
									<li>주소: 경기도 용인시 수지구 풍덕천1동 삼성타워 201호</li>
									<li>Copyright &copy; 2017. All Rights Reserved by <a href="#">(주)이노베스트</a></li>
