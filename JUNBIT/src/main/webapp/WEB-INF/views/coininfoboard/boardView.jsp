...
<body>
	...
	<script type="text/javascript">
		...
		function navMenuColorSetting() {
			...
			//서버용
			if (urlpath.indexOf("/coininfoboard") != -1) {

				$("#navmenu_coininfoboard").css("color", "#39a1f4");
				...
				$.ajax({
					...
					success : function(retVal) {
						...
						if (retVal == "success") {
							...
							location.href = "${pageContext.request.contextPath}/coininfoboard/view?id=" + $("#board_id").val();
		...
		function boardSetting() {
			...
			$("#reply_save").click(function() {
				...
				//ajax 호출
				$.ajax({
					url : "${pageContext.request.contextPath}/coininfoboard/reply/save",
					dataType : "json",
					contentType : "application/x-www-form-urlencoded; charset=UTF-8",
					type : "post",
					async : false, //동기: false, 비동기: ture
			...
			$("button[name='reply_del']").click(function() {
				...
				//ajax 호출
				$.ajax({
					url : "${pageContext.request.contextPath}/coininfoboard/reply/del",
					dataType : "json",
					contentType : "application/x-www-form-urlencoded; charset=UTF-8",
					type : "post",
					async : false, //동기: false, 비동기: ture
			...
			$("#modify").click(function() {
				...
				//ajax 호출
				$.ajax({
					url : "${pageContext.request.contextPath}/coininfoboard/check",
					dataType : "json",
					contentType : "application/x-www-form-urlencoded; charset=UTF-8",
					type : "post",
					async : false, //동기: false, 비동기: ture
					...
					success : function(retVal) {
						...
						if (retVal.code != "OK") {
							...
							location.href = "${pageContext.request.contextPath}/coininfoboard/edit?id=" + $("#board_id").val();
						}
			...
			$("#delete").click(function() {
				...
				//ajax 호출
				$.ajax({
					url : "${pageContext.request.contextPath}/coininfoboard/del",
					dataType : "json",
					contentType : "application/x-www-form-urlencoded; charset=UTF-8",
					type : "post",
					async : false, //동기: false, 비동기: ture
