			...
			<div class="col-sm-12 col-xs-12">
				<div class="resultBar barSpaceAdjust">
					...
					<ul class="list-inline">
						<li class="active"><a href="listing-sidebar-map-full.html"><i class="fa fa-th" aria-hidden="true"></i></a></li>
						<li><a href="listing-sidebar-map-left.html"><i class="fa fa-th-list" aria-hidden="true"></i></a></li>
					</ul>
				</div>
					...
					<div class="row">
						<div class="col-sm-5 col-xs-12">
							<div class="categoryImage">
								<img src="resources/img/things/things-1.jpg" alt="Image category" class="img-responsive img-rounded">
				...
				<div class="listContent">
					<div class="row">
						<div class="col-sm-5 col-xs-12">
							<div class="categoryImage">
								<img src="resources/img/things/things-2.jpg" alt="Image category" class="img-responsive img-rounded">
								<span class="label label-primary">Verified</span>
							</div>
						</div>
						<div class="col-sm-7 col-xs-12">
				...
				<div class="listContent">
					<div class="row">
						<div class="col-sm-5 col-xs-12">
							<div class="categoryImage">
								<img src="resources/img/things/things-3.jpg" alt="Image category" class="img-responsive img-rounded">
								<span class="label label-primary">Verified</span>
							</div>
						</div>
						<div class="col-sm-7 col-xs-12">
				...
				<div class="row">
					<div class="col-sm-4 col-xs-12">
						<div class="sidebarInner sidebarCategory pull-left mt20">
					...
					<div class="col-sm-4 col-xs-12">
						<div class="clearfix map-sidebar map-right map-margin-btm  pull-left mt20">
