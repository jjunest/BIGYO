			...
			<div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
				<div class="login-form">
					...
					<form role="form" id="signUpForm" action="${pageContext.request.contextPath}/signup_process">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">연락처</label> <input type="text" class="form-control" name="signup_phonenum" id="signup_phonenum" placeholder="휴대전화 번호"> <label> 
							</label>
						</div>
						<div class="form-group">
						...
						<div class="form-group col-xs-12">
							<div class="checkbox">
								<label> <input type="checkbox" id="agreeCheckbox_personalInfo" name="agreeCheckbox_personalInfo"> 개인정보 취급 방침에 동의합니다.
								</label>
							</div>
							<div class="checkbox">
								<label> <input type="checkbox" id="agreeCheckbox_serviceUse" name="agreeCheckbox_serviceUse"> 미투코리아(서비스) 이용 약관에 동의합니다.
								</label>
							</div>
						</div>
						...
						<div style="text-align: center; margin: 8px">
							<button type="submit" id="signup_submit" class="btn btn-theme-bg" style="width: 80%">미투코리아 회원가입하기</button>
						</div>
					...
					$.ajax({
						...
						success : function(data) {
							if (data == "success") {
								...
								$("#email_dupcheck_result").html("이미 등록된 이메일입니다.");
