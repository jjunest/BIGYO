...
<div class="main-wrapper">
	...
	<div align="center">
		<table width="1200px">
			<tr>
				<td>제목: <input type="text" id="subject" name="subject" style="width: 600px;" placeholder="제목" value="${boardView.subject}" />
				 <c:set var="user"
						value="${pageContext.request.userPrincipal.name}" /> <input type="hidden" id="writer" name="writer" style="width: 170px;" maxlength="10" placeholder="작성자" value="${user}" />
				
      
      
						 <input type="hidden" id="password" name="password" style="width: 170px;" maxlength="10" value="password" />
	...
	<script type="text/javascript">
            $(document).ready(function(){
            	...
            	$("#save").click(function(){
            		...
            		//ajax 호출
            		$.ajax({
            			url			:	"${pageContext.request.contextPath}/freetalkboard/save",
            			dataType	:	"json",
            ...
            function ckeditorSetting(){
            	 CKEDITOR.replace( 'content', {//해당 이름으로 된 textarea에 에디터를 적용
                     width:'100%',
                     height:'400px',
                     filebrowserImageUploadUrl: '${pageContext.request.contextPath}/freetalkboard/imageUpload' //여기 경로로 파일을 전달하여 업로드 시킨다.
                 });
