...
// map center
var center = new google.maps.LatLng(37.51816434588495, 126.93697119523038);
...
function initialize() {
	...
	/*
	 * Path to json file that contains listing data for the marker. Make sure
	 * you are calling this file through a server.
	 */
	var url = 'resources/js/listings.json';

	// define the format of the file retrive from server. here it is in JSON
	// format
	var mapdata = {
		format : 'json'
	};
	// the ajax callback function. Do all the stuff you want to do with the
	// remote data in between this function.
	function getContent(data) {
		// loop through each of the single JSON object obtained from the JSON
		// file.
		var markers = [];
				...
				.each(
						...
						function(i, value) {
							...
							function getMarkerContent(value) {
								var content = '<div id="marker-' + value.id
										+ '" class="flip-container">'
										+ verified + '<div class="flipper">'
							...
							// When this event is fired the Info Window is
							// opened.
							google.maps.event
									.addListener(
											marker,
