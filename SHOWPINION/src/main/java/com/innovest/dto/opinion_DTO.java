...
public class opinion_DTO {
	...
	public opinion_DTO(Integer sp_opinion_rcdno, Integer sp_opinion_topicrcdno,
			...
			Integer sp_opinion_warning, Integer sp_opinion_good, String sp_opinion_type,
		...
		this.sp_opinion_good = sp_opinion_good;
	...
	public Integer getSp_opinion_good() {
		return sp_opinion_good;
	}

	public void setSp_opinion_good(Integer sp_opinion_good) {
		this.sp_opinion_good = sp_opinion_good;
	}
