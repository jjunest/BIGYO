		...
		<div class="row">
			...
			<div class="col-sm-7 text-right">
				<ul class="list-inline top-dark-right">
					...
					<li class=""><a href="${pageContext.request.contextPath}/">사용자 페이지 가기 </a></li>
	...
	<div class="container">
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class=""><a href="${pageContext.request.contextPath}/admin_insert_TVTopic">TV토론주제 입력 </a></li>
				<li class=""><a href="${pageContext.request.contextPath}/all_TVshow_Topics">쇼피니언 선정 주제 입력 </a></li>
