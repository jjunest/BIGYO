		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<input type="password" style="text-align: center" id="report_password" width="100%" maxlength="20" placeholder="글 비밀번호 입력" /> <input type="text" style="text-align: center"
	...
	<div class="modal fade" id="replyDeleteModal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<input type="password" style="text-align: center" id="reply_password_inmodal" width="100%" maxlength="20" placeholder="댓글 비밀번호 입력" /> <input type="text" style="text-align: center"
